...
// $Id: Template.php 238 2019-03-17 15:06:28Z Luisehahne $
...
namespace vendor\phplib {
     ...
     * @access    public
      ...
      * 8 = debug (outputs all variables calls with parameters).
      *
     ...
     * @return    void
      ...
      *
     * @param     $root         string containing new \vendor\phplib\Template directory
     * @see       root
     * @access    public
     * @return    boolean
      */
...
/* */
        if (($this->debug & 8)&&!in_array($parent,$this->aHideVarkeys)){
    ...
    */
    ...
    //      $varvals_quoted[$k] = str_replace(['\\\\', '$'], ['\\\\\\\\', '\\\\$'], $v);
          }
...
} // end of namespace vendor\phplib
