                ...
                <div id="aba-divisor"></div>
                <div id="aba-opcao"><a href="/portal/en/?language=en"><img src="/skin/pro-reitorias/images/band-inglaterra.gif" width="20px" title="International Visitors" alt="International Visitors"></a></div>
                <div id="aba-divisor"></div>
                <div id="aba-opcao"> <!--id="aba-opcao-transparencia"-->
                    <a href="http://www.uel.br/portaltransparencia/">TRANSPAR&Ecirc;NCIA
                    <img border="0" src="/skin/img/logo-transparencia.gif" align="top" height="21" width="21" title="Portal da Transparência" style="margin: -3px 0px 0px 3px;"/>
                    </a>
                </div>
