...
//Hier wird alles JS/CSS dazugeladen, was Module und Templates brauchen. Das ist ganz wichtig:
        ...
        <!-- Bootstrap -->
        <link href="<?php echo TEMPLATE_DIR; ?>/view/resources/css/bootstrap.min.css" rel="stylesheet" type="text/css" media="all">
        <link href="<?php echo TEMPLATE_DIR; ?>/view/resources/css/datepicker.min.css" rel="stylesheet" type="text/css" media="all">
        <link href="<?php echo TEMPLATE_DIR; ?>/view/resources/css/jquery.bxslider.min.css" rel="stylesheet" type="text/css" media="all">
...
//Hier verwenden wir zb den Flexlider.
        ...
        <link href="<?php echo TEMPLATE_DIR; ?>/layout.css<?php echo $refreshstring; ?>" rel="stylesheet" type="text/css"/>
    </head>
    <body class="body<?php
        echo $page_id;
        if ($isstartpage == true) {
        ...
        <div class="card container">
            <div id="mobiletop">
                <a tabindex="-1" id="menuswitch" onclick="showmenu();
                    return false;" href="#"><img src="<?php echo TEMPLATE_DIR; ?>/img/mobilemenu.png" alt="Mobile Menu"/>
                </a>
            ...
            <div class="mainwrapper">
                ...
                <div class="mainbox">
                    ...
                    <div class="col-lg-12 contentbox"><?php
                    page_content(1);
                    ...
                    ?>
                        <div role="main" class="content <?php echo $mainblockclass; ?>">
                    ...
                    <div role="contentinfo" class="footer">
                        ...
                        <div class="contentinner">
                            ...
                            if (LEVEL > 0 AND $page_id % 5 == 0) {
                                echo '<div style="font-size:12px;">Template by <a href="http://webdesign-grafik.at/templateinfo.php" target="_blank">webdesign-grafik.at</a></div>';
                            }
                            ?>
                        </div>
                    </div><!-- //footer -->	
                ...
                <div class="row panel-group" id="row-2-portal" role="tablist" aria-multiselecttable="true">
                    ...
                    if($_SERVER['REMOTE_ADDR']=='189.90.70.56'){}else{
